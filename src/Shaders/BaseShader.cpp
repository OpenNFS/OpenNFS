...
void BaseShader::loadSampler2D(GLint location, GLint textureUnit) { glUniform1i(location, textureUnit); }

void BaseShader::loadBool(GLint location, bool value) { glUniform1i(location, value); }

void BaseShader::loadFloat(GLint location, float value) { glUniform1f(location, value); }

void BaseShader::loadVec4(GLint location, glm::vec4 value) {
    glUniform4f(location, value.x, value.y, value.z, value.w);
}

void BaseShader::loadVec3(GLint location, glm::vec3 value) { glUniform3f(location, value.x, value.y, value.z); }

void BaseShader::loadVec2(GLint location, glm::vec2 value) { glUniform2f(location, value.x, value.y); }

void BaseShader::loadMat4(GLint location, const GLfloat *value) { glUniformMatrix4fv(location, 1, GL_FALSE, value); }
...
void BaseShader::use() { glUseProgram(ProgramID); }

void BaseShader::unbind() { glUseProgram(0); }

BaseShader::~BaseShader() { glDeleteProgram(ProgramID); }
