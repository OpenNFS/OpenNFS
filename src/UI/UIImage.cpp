...
namespace OpenNFS {
    UIImage::UIImage(UIResource const &_resource, float const _scale, uint32_t const _layer, glm::vec2 const &_location, std::string id)
        : UIElement(UIElementType::Image, _scale, _layer, _location, id), resource(_resource) {
    }
