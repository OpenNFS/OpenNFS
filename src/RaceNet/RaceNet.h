...
// 3 hidden neurons (experimental) : you can specify as many hidden layers as you want (you need to add the number of
// neurons in each) 2 output neurons (2 outputs) 0.7 learning rate (experimental)
