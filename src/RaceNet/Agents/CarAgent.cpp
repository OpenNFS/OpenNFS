...
void CarAgent::ResetToVroad(int vroadIndex, float offset) {
    ...
    glm::quat carOrientation = glm::conjugate(glm::toQuat(glm::lookAt(vroadPoint, vroadPoint - m_track->virtualRoad[vroadIndex].forward, m_track->virtualRoad[vroadIndex].normal)));
