...
void CarRenderer::render(const Camera &mainCamera, const Light &cameraLight) {
    ...
    if(car->left_rear_wheel_model.isMultiTextured){
    ...
    if(car->right_front_wheel_model.isMultiTextured){
    ...
    if(car->right_rear_wheel_model.isMultiTextured){
