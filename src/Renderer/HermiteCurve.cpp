...
glm::vec3 HermiteCurve::Interpolate(glm::vec3 const p0, glm::vec3 const p1, glm::vec3 const p2, glm::vec3 const p3, float const t, float const tension, float const bias) {
