                ...
                for (k = 0; k < 4; k++) {
                    ...
                    while ((t->nbdData[i].blk != -1) && (i < 300)) {
                            ...
                            for (long objcounter = 0; objcounter < numobj; objcounter++) {
                                ...
                                for (j = 0; j < num; j++, p++) {
                                    ...
                                    if (result != 1) {
                                        ...
                                        Pos[2] = StartPos[2];
                                        result =
                                            intersect_triangle(Pos, RayDir, corner1, corner2, corner3, &tt, &uu, &vv);
                                    } else {
                                        // j=num;
                                        i = 300;
                                    }
                                    ...
                                    /*if (result != 1) {
                                        ...
                                        Pos[1]=StartPos[1];
                                        Pos[2]=StartPos[2];
                                        result = intersect_triangle(Pos, RayDir, corner1, corner2, corner3, &tt, &uu,
                                    &vv);
                                    }
                                    else
                                    {
                        ...
                        for (uint32_t XObjCounter = 0; XObjCounter < xobj[blk2].nobj; XObjCounter++) {
                            FLOATPT *vert_array = xobj[blk2].obj[XObjCounter].vert;
                            if (xobj[blk2].obj[XObjCounter].crosstype != 6) {
                                for (uint32_t XObjPoly = 0; XObjPoly < xobj[blk2].obj[XObjCounter].nPolygons;
                                     XObjPoly++) {
