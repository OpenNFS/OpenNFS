...
void Entity::genPhysicsMesh() {
    if (type == LIGHT) {
        ...
        for (int i = 0; i < vertices.size() - 2; i += 3) {
            ...
            physicsMesh.addTriangle(Utils::glmToBullet(triangle), Utils::glmToBullet(triangle1),
    ...
    rigidBody =
        new btRigidBody(btRigidBody::btRigidBodyConstructionInfo(0, motionState, physicsShape, btVector3(0, 0, 0)));
