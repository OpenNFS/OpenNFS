...
void Entity::_GenCollisionMesh()
{
    ...
    switch (type)
    {
        ...
        case LIGHT:
        {
            ...
            {
                glm::vec3 triangle = glm::vec3((vertices[i].x / lightBoundScaleF),
                                               (vertices[i].y / lightBoundScaleF),
                                               (vertices[i].z / lightBoundScaleF));
                glm::vec3 triangle1 = glm::vec3((vertices[i + 1].x / lightBoundScaleF),
                                                (vertices[i + 1].y / lightBoundScaleF),
                                                (vertices[i + 1].z / lightBoundScaleF));
                glm::vec3 triangle2 = glm::vec3((vertices[i + 2].x / lightBoundScaleF),
                                                (vertices[i + 2].y / lightBoundScaleF),
                                                (vertices[i + 2].z / lightBoundScaleF));
