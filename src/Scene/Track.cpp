...
Track::Track(std::vector<glm::vec3> verts, std::vector<glm::vec3> norms, std::vector<glm::vec2> uvs,
             std::vector<unsigned int> texture_indices, std::vector<unsigned int> indices,
...
Track::Track(std::vector<glm::vec3> verts, std::vector<glm::vec2> uvs, std::vector<unsigned int> texture_indices,
...
Track::Track()
    : super("Track", std::vector<glm::vec3>(), std::vector<glm::vec2>(), std::vector<glm::vec3>(),
