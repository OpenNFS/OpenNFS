...
class CarModel : public Model {
  public:
    // Test
    CarModel(std::string name, std::vector<glm::vec3> verts, std::vector<glm::vec2> uvs,
    ...
    CarModel(std::string name, std::vector<glm::vec3> verts, std::vector<glm::vec2> uvs,
             std::vector<unsigned int> texture_indices, std::vector<glm::vec3> norms, std::vector<unsigned int> indices,
             glm::vec3 center_position, float specular_damper, float specular_reflectivity, float env_reflectivity);
    // Cars with Per-Polygon Flags (NFS4)
    CarModel(std::string name, std::vector<glm::vec3> verts, std::vector<glm::vec2> uvs, std::vector<glm::vec3> norms,
             std::vector<unsigned int> indices, std::vector<uint32_t> poly_flags, glm::vec3 center_position,
