...
namespace OpenNFS {
    Track TrackLoader::Load(NFSVersion const nfsVersion, const std::string &trackName) {
        ...
        switch (nfsVersion) {
            case NFSVersion::NFS_2:
                ...
                return OpenNFS::Track(LibOpenNFS::NFS2::Loader<LibOpenNFS::NFS2::PC>::LoadTrack(
                    NFSVersion::NFS_2, trackBasePath.str(), trackOutPath.str()));
            case NFSVersion::NFS_2_SE:
                trackBasePath << NFS_2_SE_TRACK_PATH << trackName;
                return OpenNFS::Track(LibOpenNFS::NFS2::Loader<LibOpenNFS::NFS2::PC>::LoadTrack(
                    NFSVersion::NFS_2_SE, trackBasePath.str(), trackOutPath.str()));
            case NFSVersion::NFS_2_PS1:
                ...
                return OpenNFS::Track(LibOpenNFS::NFS2::Loader<LibOpenNFS::NFS2::PC>::LoadTrack(
                    NFSVersion::NFS_2_PS1,
                    trackBasePath.str(), trackOutPath.str()));
            case NFSVersion::NFS_3:
                trackBasePath << NFS_3_TRACK_PATH << trackName;
                return OpenNFS::Track(LibOpenNFS::NFS3::Loader::LoadTrack(
                    trackBasePath.str(), trackOutPath.str()));
            case NFSVersion::NFS_3_PS1:
                trackBasePath << "/" << trackName;
                return OpenNFS::Track(
                    LibOpenNFS::NFS2::Loader<LibOpenNFS::NFS2::PS1>::LoadTrack(
                        NFSVersion::NFS_3_PS1, trackBasePath.str(), trackOutPath.str()));
