        ...
        switch (nfsVersion) {
            case NFSVersion::NFS_2:
                ...
                return std::make_shared<Track>(
                    LibOpenNFS::NFS2::Loader<LibOpenNFS::NFS2::PC>::LoadTrack(
            ...
            // Somewhat ironically, NFS2 PS1 tracks are more similar to NFS2 PC tracks than NFS3 PS1 tracks in format
                ...
                return std::make_shared<Track>(LibOpenNFS::NFS2::Loader<LibOpenNFS::NFS2::PC>::LoadTrack(
                    NFSVersion::NFS_2_PS1,
                    trackBasePath.str(), trackOutPath.str()));
            case NFSVersion::NFS_3:
                trackBasePath << NFS_3_TRACK_PATH << trackName;
                return std::make_shared<Track>(LibOpenNFS::NFS3::Loader::LoadTrack(
                    trackBasePath.str(), trackOutPath.str()));
