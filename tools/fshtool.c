    ...
    for (i = 0; i < nbmp; i++) {
        ...
        if (isbmp) {
            ...
            while (l >= 0) {
                ...
                if ((hdr->code & 0x7f) == 0x7B) { /* 8-bit bitmap */
                ...
                } else if ((hdr->code & 0x7f) == 0x7D) { /* 32-bit bitmap */
                ...
                } else if ((hdr->code & 0x7f) == 0x7F) { /* 24-bit bitmap */
                ...
                } else if ((hdr->code & 0x7f) == 0x7E) { /* 15-bit bitmap */
                ...
                } else if ((hdr->code & 0x7f) == 0x78) { /* 15-bit bitmap */
                    ...
                    curoffs += 2 * hdr->width * hdr->height;
                } else if ((hdr->code & 0x7f) == 0x6D) { /* 4x4=16-bit bitmap */
